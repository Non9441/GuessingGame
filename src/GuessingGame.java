...
/**
 * Game of guessing a secret number. The game let the user to guess a number that program random for you.
...
public class GuessingGame{
	 ...
	 * 
	 * @param number is the guess that come from user.
	 ...
	 * @param prompt is the hint that you want to set related to the answer.
	 */
